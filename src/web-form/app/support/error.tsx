...
export default function SupportError({ reset }: ErrorProps) {
  return (
    <main className="min-h-screen bg-background text-foreground flex items-center justify-center px-4">
      <div className="text-center">
        <h1 className="text-2xl font-bold mb-3">Support form unavailable</h1>
        <p className="text-slate-400 mb-6">
          We&apos;re having trouble loading the support form. Please try again.
        </p>
